 ...
 * --------------------------------------------------------------------- */
#define MAX_TOKENS        8192   /* max tokens per source unit (gui lib ~3500 + program ~4500) */
#define MAX_AST_NODES     4096   /* max AST nodes per source unit               */
...
#define MAX_SRC_LEN       131072 /* max combined (preprocessed) source length    */
...
#define MAX_IMPORT_BUF    32768  /* max source bytes per imported library file  */
#define MAX_FUNCTIONS     128    /* max user-defined function definitions        */
#define MAX_PARAMS        8      /* max parameters per function                  */
#define MAX_LOCALS        128    /* max local variables per function             */
#define MAX_STRINGS       256    /* max distinct string literals per program     */
#define MAX_STR_LEN       256    /* max characters in one string literal         */
#define MAX_FIXUPS        1024   /* max jump-fixup entries                       */
